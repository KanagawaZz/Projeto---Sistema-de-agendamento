...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'local-development-secret-key-change-this-before-deploying-9f3c7a1b',
)
...
WHATSAPP_REMINDER_TEMPLATE_NAME = os.environ.get('WHATSAPP_REMINDER_TEMPLATE_NAME', 'appointment_reminder')
WHATSAPP_REMINDER_TEMPLATE_LANGUAGE = os.environ.get('WHATSAPP_REMINDER_TEMPLATE_LANGUAGE', 'pt_BR')
WHATSAPP_HTTP_TIMEOUT = int(os.environ.get('WHATSAPP_HTTP_TIMEOUT', '10'))
