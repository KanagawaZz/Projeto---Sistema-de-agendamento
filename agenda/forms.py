...
from .models import Appointment, Business, BusinessPage, Service, WorkingDay, WorkingHours
...
class BusinessForm(forms.ModelForm):
	class Meta:
		model = Business
		fields = ('name', 'description', 'whatsapp_phone')
		labels = {
...
class BusinessPageForm(forms.ModelForm):
	class Meta:
		model = BusinessPage
		fields = ('public_title', 'public_description', 'cta_label', 'theme', 'is_published')
		labels = {
