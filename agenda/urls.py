...
urlpatterns = [
    ...
    path('business/whatsapp/connect/', views.whatsapp_connect, name='whatsapp_connect'),
    path('business/whatsapp/reminders/', views.whatsapp_reminder_list, name='whatsapp_reminder_list'),
